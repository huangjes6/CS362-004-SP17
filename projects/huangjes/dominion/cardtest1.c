...
int main()
{
	...
	playAdventurer(2, currentPlayer, &G, tempHand, 0, 0);
	...
	playAdventurer(0, currentPlayer, &G, tempHand, 0, 0);
	if (G.handCount[currentPlayer] == preG.handCount[currentPlayer] + 2)
	...
	G.hand[currentPlayer][0] = adventurer;
	i = playAdventurer(0, currentPlayer, &G, tempHand, 0, 0);
